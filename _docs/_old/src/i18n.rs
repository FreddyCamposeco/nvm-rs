// This file is generated by rust-i18n. Run `cargo run --bin rust-i18n-cli` to regenerate it.
//! Generated by `cargo run --bin rust-i18n-cli@3.0.1`
//! Run `cargo run --bin rust-i18n-cli@3.0.1` to regenerate this file.
