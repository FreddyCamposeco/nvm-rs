...
- ✅ List installed and remote versions with enhanced formatting (similar to nvm-windows)
...
- `nvm ls` - List installed versions with enhanced formatting (shows current version, system version, latest, and LTS versions)
